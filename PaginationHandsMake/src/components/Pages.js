...
const Pages = ({ photos, loading }) => {
  //   debugger;
  // Давайте пропишемо логіку статусу завантаження
  //   if (loading) {
  //     //   Якщо нам приходить лоадінг то ми повертаємо вміст h2
  //     return <h2>Loading...</h2>;
  //   }
  // Якщо приходе не Loading повертаємо список номерів сторінок
  return (
